...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'aba.adan-office-services.com,monya.adan-office-services.com,www.monya.adan-office-services.com,localhost,127.0.0.1,').split(',')
